...
truncate_table "enquete_forms"
truncate_table "enquete_form_columns"
truncate_table "enquete_answers"
truncate_table "enquete_answer_columns"
...
layout  = create_cms_layout :name => "#{mod}", :title => "アンケート"
...
form = Enquete::Form.create :content_id => content.id, :state => 'public', :sort_no => 1,
  ...
  :body      => %Q(<p>ジョールリ市へのお問い合わせは下記のフォームに必要事項を入力の上、「確認する」ボタンを押してください。<br />「※」がついている項目は、必ずご記入ください。<br /><br /><span style="color: #ff0000;">※このアンケートはサンプルです。</span></p>),
